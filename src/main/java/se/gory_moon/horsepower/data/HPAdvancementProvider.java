...
public class HPAdvancementProvider implements IDataProvider {
    ...
    private void registerAdvancements(Consumer<Advancement> consumer) {
        Advancement root = Advancement.Builder.builder().withDisplay(ModBlocks.MANUAL_MILLSTONE_BLOCK.get(), new TranslationTextComponent("advancements.horsepower.root.title"), new TranslationTextComponent("advancements.horsepower.root.description"), new ResourceLocation("textures/gui/advancements/backgrounds/stone.png"), FrameType.TASK, false, false, false).withRequirementsStrategy(IRequirementsStrategy.OR).withCriterion("get_millstone", InventoryChangeTrigger.Instance.forItems(ModBlocks.MANUAL_MILLSTONE_BLOCK.orElse(null))).withCriterion("get_wheat", InventoryChangeTrigger.Instance.forItems(Items.WHEAT)).register(consumer, "horsepower:horsepower/root");
